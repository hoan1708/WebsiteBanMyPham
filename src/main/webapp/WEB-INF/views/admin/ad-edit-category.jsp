                ...
                <!-- basic table -->
               	<div class="row">
                	<div class="col-12">
	                    <div class="card">
	                        <div class="card-body">
	                        	<sf:form class="form" action="${classpath}/manager/edit-category" method="post" modelAttribute="category" >
	                        		 <div class="form-body">
	                        			<div class="row">
		                        			<div class="col-md-6">
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        <a href="${classpath }/manager/showCategory" class="btn btn-secondary active" role="button" aria-pressed="true">
			                                        	Back to list
			                                        </a>
